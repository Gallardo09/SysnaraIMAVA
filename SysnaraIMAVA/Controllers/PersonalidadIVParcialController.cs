...
{
    public class PersonalidadIvParcialController : Controller
    {
        private readonly DbimavaContext _context;

        public PersonalidadIvParcialController(DbimavaContext context)
        {
            _context = context;
        }

        // GET: PersonalidadIvParcialController
        ...
        {
            var query = _context.PersonalidadIvps
        ...
        public IActionResult VerificarDatos(int? idAño, string idGrado)
        {
            ...
            var datosFiltrados = _context.PersonalidadIvps
            ...
            try
            {
                ...
                using (var package = new ExcelPackage())
                {
                    ...
                    for (int i = 0; i < datosFiltrados.Count; i++)
                    {
                        ...
                        worksheet.Cells[i + 8, 9].Value = personalidad.IdpersonalidadIv;
                    ...
                    var fileName = $"Personalidad_{idAño}_{idGrado}_IV.xlsx";
        ...
        public IActionResult DescargarExcelenBlancoPersonalidadIV(int? idAño, string idGrado)
        {
            if (idAño == null || string.IsNullOrEmpty(idGrado))
            {
                return BadRequest("Debe proporcionar ambos parámetros: Año y Grado.");
            ...
            {
                var datosFiltrados = _context.PersonalidadIvps
                                              .Where(p => p.Idaño == idAño && p.Idgrado == idGrado && p.IdpersonalidadIv != null)
                                              .ToList();
                ...
                using (var package = new ExcelPackage())
                {
                    ...
                    else
                    {
                        ...
                        foreach (var dato in datosFiltrados)
                        {
                            ...
                            worksheet.Cells[row, 9].Value = dato.IdpersonalidadIv;
        ...
        public async Task<IActionResult> SubirPersonalidades(IFormFile archivoExcel)
        {
            ...
            try
            {
                using (var package = new ExcelPackage(archivoExcel.OpenReadStream()))
                {
                    ...
                    List<PersonalidadIvp> personalidades = new List<PersonalidadIvp>();

                    for (int row = 8; row <= rowCount; row++)
                    {
                        var personalidad = new PersonalidadIvp
                        {
                            ...
                            IdpersonalidadIv = int.TryParse(worksheet.Cells[row, 9].Text, out var idPersonalidad) ? idPersonalidad : 0,
                        ...
                        {
                            var existingRecord = _context.PersonalidadIvps
                            ...
                            _context.PersonalidadIvps.Add(personalidad);
                        }
                        else if (tipoIngreso == "EDITANDO")
                        {
                            var personalidadExistente = _context.PersonalidadIvps
                                .FirstOrDefault(p => p.Idest == personalidad.Idest && p.Idaño == personalidad.Idaño && p.IdpersonalidadIv == personalidad.IdpersonalidadIv);
                            ...
                            if (personalidadExistente != null)
                            {
                                ...
                                _context.PersonalidadIvps.Update(personalidadExistente);
                            }
                            else
                            {
