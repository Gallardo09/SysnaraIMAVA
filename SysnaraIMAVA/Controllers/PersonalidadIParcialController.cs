...
{
    public class PersonalidadIParcialController : Controller
    {
        private readonly DbimavaContext _context;

        public PersonalidadIParcialController(DbimavaContext context)
        {
            _context = context;
        }

        // GET: PersonalidadIParcialController
        ...
        public IActionResult VerificarDatos(int? idAño, string idGrado)
        {
            ...
            var datosFiltrados = _context.Personalidads
            ...
            try
            {
                ...
                using (var package = new ExcelPackage())
                {
                    ...
                    for (int i = 0; i < datosFiltrados.Count; i++)
                    {
                        ...
                        worksheet.Cells[i + 8, 9].Value = personalidad.Idpersonalidad;
                    ...
                    var fileName = $"Personalidad_{idAño}_{idGrado}.xlsx";
        ...
        public IActionResult DescargarExcelenBlancoPersonalidad(int? idAño, string idGrado)
        {
            ...
            {
                var datosFiltrados = _context.Personalidads
                                              .Where(p => p.Idaño == idAño && p.Idgrado == idGrado && p.Idpersonalidad != null)
                                              .ToList();
                ...
                using (var package = new ExcelPackage(archivoExcel.OpenReadStream()))
                {
                    ...
                    for (int row = 8; row <= rowCount; row++)
                    {
                        var personalidad = new Personalidad
                        {
                            ...
                            Idpersonalidad = int.TryParse(worksheet.Cells[row, 9].Text, out var idPersonalidad) ? idPersonalidad : 0,
                        ...
                        {
                            var existingRecord = _context.Personalidads
                            ...
                            _context.Personalidads.Add(personalidad);
                        }
                        else if (tipoIngreso == "EDITANDO")
                        {
                            var personalidadExistente = _context.Personalidads
                                .FirstOrDefault(p => p.Idest == personalidad.Idest && p.Idaño == personalidad.Idaño && p.Idpersonalidad == personalidad.Idpersonalidad);
                            ...
                            if (personalidadExistente != null)
                            {
                                ...
                                _context.Personalidads.Update(personalidadExistente);
                            }
                            else
                            {
